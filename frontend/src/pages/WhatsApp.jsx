...
export default function WhatsApp() {
  ...
  return (
    <div style={{ minHeight: 'calc(100vh - 48px)', background: 'var(--theme-surface-faint3)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ textAlign: 'center', color: '#aaa' }}>
        ...
        <div style={{ fontSize: 18, fontWeight: 700, color: 'var(--theme-text-strong)', marginBottom: 8 }}>WhatsApp CRM</div>
