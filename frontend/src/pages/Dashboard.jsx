    ...
    return (
      <div style={{ padding: 24, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '80vh', gap: 16 }}>
        ...
        <div style={{ display: 'flex', gap: 12 }}>
          <button 
            onClick={refresh}
            style={{ background: 'var(--btn-gradient)', color: '#fff', border: 'none', padding: '10px 20px', borderRadius: 8, fontSize: 13, fontWeight: 600, cursor: 'pointer', boxShadow: '0 4px 6px -1px rgba(var(--theme-primary-rgb), 0.2)' }}
          >
            Retry Fetching
          </button>
          <button 
